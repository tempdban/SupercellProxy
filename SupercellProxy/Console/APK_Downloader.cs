        ...
        { 
            ...
            try
            {
                ...
                if (DesiredGame == Game.CLASH_ROYALE)
                    wc.DownloadFile(new Uri("https://infinitymodding.net/projects/supercellproxy/modded_clash_royale.apk"), "modded_clash_royale.apk");
                else if (DesiredGame == Game.CLASH_OF_CLANS)
                    wc.DownloadFile(new Uri("https://infinitymodding.net/projects/supercellproxy/modded_clash_of_clans.apk"), "modded_clash_of_clans.apk");
                else
                    wc.DownloadFile(new Uri("https://infinitymodding.net/projects/supercellproxy/modded_boom_beach.apk"), "modded_boom_beach.apk");
